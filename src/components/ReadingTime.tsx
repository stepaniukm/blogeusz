...
export default function ReadingTime({ readingTime, className, size }: Props) {
  return (
    <div className={`flex items-center space-x-2 opacity-80 ${className}`}>
      ...
      <span className="sr-only">Do przeczytania w:</span>
...
const FormattedReadingTime = ({ readingTime }: { readingTime: number }) => {
